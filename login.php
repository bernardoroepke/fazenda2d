            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block" style="background-image: url('img/fotoInicio2.png');"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                ...
                                ?>
                                    ...
                                    <form action = "validaLogin.php" method = "POST" class="user">
                                        <div class="form-group">
                                            <input name="login" type="text" class="form-control form-control-user" placeholder="Usuário">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="registrar.php">Criar uma conta</a>
                                    </div>
                                </div>
                            </div>
                        </div>
